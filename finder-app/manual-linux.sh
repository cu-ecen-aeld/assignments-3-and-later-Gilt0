...
cp ${FINDER_APP_DIR}/lib64/libm.so.6 ${OUTDIR}/rootfs/lib64
cp ${FINDER_APP_DIR}/lib64/libresolv.so.2 ${OUTDIR}/rootfs/lib64
cp ${FINDER_APP_DIR}/lib64/libc.so.6 ${OUTDIR}/rootfs/lib64
...
echo "gzip -f ${OUTDIR}/initramfs.cpio"
